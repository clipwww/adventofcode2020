function day11() {
  ...
  const puzzle = `LLLLL.LLL.LLLLLLLLLLLLLLL.LLLLLLLLL.LLLLLLLLLLLLL.LLLLLLL.LLLLLLL.LLLLL.LLLLLLLLLLLLLLLLLLL.LLLLL
      ...
      newArr = newArr.map((row, i) => {
        return row.map((col, j) => {
          ...
          const position = [
            ...
            oldArr[i - 1] ? oldArr[i - 1][j] : undefined,
            oldArr[i - 1] ? oldArr[i - 1][j + 1] : undefined,
            oldArr[i][j - 1],
            oldArr[i][j + 1],
            oldArr[i + 1] ? oldArr[i + 1][j - 1] : undefined,
          ...
          if (col === '#' && position.filter(seat => seat === '#').length >= 4) {
            return 'L'
          }
